...
With a copy by email to: legal@jfksocial.com
...
Email: legal@jfksocial.com
Royalty reporting: royalties@jfksocial.com
Trademark and brand: brand@jfksocial.com
Reach-symmetry compliance: compliance@jfksocial.com
...
* Backend / Go server (the "AI_Coding" open-source publication): https://github.com/ACT3ai/jfksocial_server.git
* Frontend / React shell (the "Front_AI_Coding" open-source publication): https://github.com/ACT3ai/jfksocial_frontend.git
* Devops, install, and deployment guidance for AWS and other server types: https://github.com/ACT3ai/jfksocial_devops.git
