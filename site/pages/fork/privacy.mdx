---
title: WeCitizens Fork Operator Privacy Policy
description: How ACT 3 AI, Inc. collects, uses, retains, shares, and protects the personal information of WeCitizens Fork Operators (also called "WC Fork Customers") in connection with the WeCitizens Fork Operator License Agreement. Covers operator-vs-end-user data controllership, license-verification telemetry, royalty-reporting data, Reach-Symmetry audit data, and brand-registration data.
---

# WeCitizens Fork Operator Privacy Policy

Effective Date: 2026-05-14. Last Updated: 2026-05-14.

This Privacy Policy describes how ACT 3 AI, Inc., a Delaware corporation ("Company," "we," "us," or "our"), processes personal information about individuals who, on behalf of an Operator under the WeCitizens Fork Operator License Agreement (the "License"), download, register for, operate, modify, or distribute the WeCitizens Social software stack (the "Software"). Operators are referred to informally as "WeCitizens Fork Customers" or "WC Fork Customers"; this Policy applies to those parties regardless of which informal label is used. This Policy is the companion document to the License and incorporates the License's defined terms; capitalized terms not defined here have the meanings given in the License. This Policy applies only to Company's processing of Operator-side data; the End Users of any WeCitizens Fork are not covered by this Policy and must look to the Operator of that WeCitizens Fork for its own privacy disclosures.
...
1.2 You are an "End User" of a WeCitizens Fork — and outside the scope of this Policy — if you have an account on, or otherwise interact with, a WeCitizens Fork run by an Operator. End Users must consult that Operator's own privacy policy, which the Operator is required to publish under Section 12.2 of the License.

1.3 "WeCitizens Fork Customer" and "WC Fork Customer" are informal alternative names for Operator used in Company communications. They refer to the same Operator covered by this Policy.

## 2. Controllership: Why Operator — Not Company — Is the Controller of End User Data

2.1 The Operator Is the End User Data Controller. When an Operator runs a WeCitizens Fork, the Operator alone collects, stores, and processes End User personal information (account credentials, posts, follow graphs, direct messages, IP addresses, device identifiers, payment data, and similar). Company does not have a contractual relationship with those End Users, does not have access to End User content on a WeCitizens Fork, and is not a controller, joint controller, or processor of End User data for purposes of the GDPR, the CCPA/CPRA, the VCDPA, the CPA, the CTDPA, the UCPA, or any other applicable data-protection law.

2.2 Federation Does Not Create Controllership. Where a WeCitizens Fork participates in a federated network (Nostr, ActivityPub, or cross-network adapters), content published by End Users on that WeCitizens Fork may propagate to third-party relays and servers. Company is not the operator of, and does not control, those third-party relays or servers, and is not a controller of End User content propagated through federation.

2.3 What Company Does See About End Users. Through the license-verification telemetry described in Section 3, Company may see aggregate, non-individual counts (such as "this WeCitizens Fork reports approximately N daily active users"). Company does not, under the default Software configuration, receive individual End User identifiers, content, IP addresses, or device identifiers. Operator is responsible for ensuring its End Users are informed of, and where required have provided a lawful basis for, the limited aggregate data the Software sends to Company.
...
(c) aggregate WeCitizens Fork health metrics (uptime in hours since last restart, current Software version, deployment region at country level, approximate End User population in order-of-magnitude buckets such as "&lt;100", "100–1,000", "1,000–10,000", etc.);
(d) an Operator-supplied billing identifier (used to associate the WeCitizens Fork with Operator's royalty reporting); and
(e) a license-verification token issued by Company.

3.2 What the Software Does NOT Send. Under the default configuration, the Software does not transmit to Company any End User identifier, any End User account data, any End User content, any End User IP address, any End User device fingerprint, the contents of any database table, or any moderation decision made on a WeCitizens Fork.
...
3.5 No Use for Marketing to End Users. Company does not use telemetry data to market to, advertise to, or otherwise communicate with End Users of any WeCitizens Fork. Company has no End User identifiers to begin with.

## 4. Royalty-Reporting Data and Audit Records

4.1 What Operator Submits. Under Section 11 of the License, Operator submits a quarterly royalty report. The report includes Fork Revenue figures by WeCitizens Fork, the Value Share calculation for any bundled product or service, royalty due, WeCitizens Fork descriptions (brand, public URL, End User population), and an officer certification.
...
5.1 Why This Section Exists. Section 9 of the License imposes a Reach-Symmetry obligation on Operator: Operator must not give Company Users on the WeCitizens Fork less Reach than Operator gives Operator's own End Users at the same access tier. To verify compliance, Company conducts comparative testing under Section 11.4 of the License. This Section describes the personal information Company processes in connection with that testing.

5.2 What Company Processes. Reach-Symmetry audits involve three kinds of records:

(a) Test-Account Activity Records — accounts (whether Company Users or non-Company-User test personas) that Company or an independent auditor operates on a WeCitizens Fork under the terms of the WeCitizens Fork's published rules of acceptable use, and the activity, content, and engagement records generated by those accounts;

(b) Comparative Measurements — Reach measurements collected from the WeCitizens Fork's public surfaces (e.g., counts of impressions, ranking positions, search-result positions, notification-eligibility flags) about the test accounts and about a sample of comparator accounts;
...
13.2 How to Exercise. To exercise any right, email contactus@act3ai.com from the email address on file with your Operator account, or submit a request through the form at wecitizens.social/legal/privacy-request. We will respond within the time required by applicable law (forty-five (45) days for California requests, with a single forty-five-day extension where reasonably necessary; one month for GDPR requests, with up to two additional months for complex requests). We may need to verify your identity and your authority to act on behalf of the Operator.
...
14.2 End Users of any WeCitizens Fork are governed by the Operator's own policies, including the Operator's compliance with the Children's Online Privacy Protection Act ("COPPA"), 15 U.S.C. § 6501 et seq., and any applicable state or foreign children's-privacy law. Operator's compliance with COPPA on its WeCitizens Fork is Operator's responsibility under Section 7 of the License.
...
(g) Inferences — derived signals such as whether a particular WeCitizens Fork is likely under-reporting Fork Revenue or non-compliant with Section 9 of the License (used solely for audit triage, not for advertising or external decision-making about an Operator Representative's individual rights).
...
ACT 3 AI, Inc.
Attn: Privacy — WeCitizens Fork
Email: contactus@act3ai.com
Mailing address: [Notice Address On File With Company]

20.2 For EU/UK matters, our representative is identified on the privacy page at wecitizens.social/legal.

## 21. Related Documents

21.1 WeCitizens Social maintains three companion legal documents. This WeCitizens Fork Operator Privacy Policy applies to Operators (also referred to informally as "WeCitizens Fork Customers" or "WC Fork Customers") and to their Operator Representatives who interact with Company in connection with running the WeCitizens Social software on their own infrastructure. The two complementary privacy policies are:
...
* [Consumer (WeCitizens.social User) Privacy Policy](/consumer/privacy) — how Company processes personal information of End Users of Company's hosted service at wecitizens.social.

21.2 Companion license documents:

* [Rev-Shared Influencers License](/influencers/license)
* [Consumer (WeCitizens.social User) License](/consumer/license)
* [WeCitizens Fork Operator License Agreement](/fork/license) — the contract this Privacy Policy accompanies.
