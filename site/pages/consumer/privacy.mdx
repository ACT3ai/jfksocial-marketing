---
title: WeCitizens Social Consumer Privacy Policy
description: How ACT 3 AI, Inc. collects, uses, shares, and protects personal information about consumers who use wecitizens.social and related services.
---

# WeCitizens Social Consumer Privacy Policy

**Effective Date:** May 12, 2026
**Last Updated:** May 12, 2026

This Consumer Privacy Policy (this "**Policy**") describes how ACT 3 AI, Inc., a Delaware corporation ("**WeCitizens Social**," "**we**," "**us**," or "**our**"), collects, uses, shares, and protects personal information about Consumers who use the websites, applications, application programming interfaces, and other online services we operate at wecitizens.social and related properties (collectively, the "**Services**"). This Policy is incorporated into and governed by the Consumer Terms of Service located at [`/consumer/license`](/consumer/license). Capitalized terms used but not defined here have the meanings given to them in the Consumer Terms of Service.
...
2. [Nostr Identity, Public-by-Default Events, and What Leaves Our Control](#2-nostr-identity-public-by-default-events-and-what-leaves-our-control)
3. [Relays, Media Servers, and Cross-Network Federation](#3-relays-media-servers-and-cross-network-federation)
4. [Categories of Personal Information We Collect](#4-categories-of-personal-information-we-collect)
5. [How We Use Personal Information](#5-how-we-use-personal-information)
6. [AI and Machine-Learning Use of Your Content](#6-ai-and-machine-learning-use-of-your-content)
7. [Content Moderation, Trust and Safety, CSAM Reporting](#7-content-moderation-trust-and-safety-csam-reporting)
8. [Premium Plan Billing Data](#8-premium-plan-billing-data)
9. [How We Share Personal Information](#9-how-we-share-personal-information)
10. [Retention of Personal Information](#10-retention-of-personal-information)
11. [Your Privacy Rights and How to Exercise Them](#11-your-privacy-rights-and-how-to-exercise-them)
12. [California Residents (CCPA / CPRA)](#12-california-residents-ccpa--cpra)
13. [Other U.S. State Privacy Rights (Virginia, Colorado, Connecticut, Utah, and Others)](#13-other-us-state-privacy-rights-virginia-colorado-connecticut-utah-and-others)
14. [Children Under 13 (COPPA) and Minors 13 to 17](#14-children-under-13-coppa-and-minors-13-to-17)
15. [Data Security](#15-data-security)
16. [International Users and Cross-Border Transfers](#16-international-users-and-cross-border-transfers)
17. [Cookies and Similar Technologies](#17-cookies-and-similar-technologies)
18. [Log Files and Server Telemetry](#18-log-files-and-server-telemetry)
19. [Changes to This Policy](#19-changes-to-this-policy)
20. [Contact Us About Privacy](#20-contact-us-about-privacy)
...
This Policy applies to natural persons who use the consumer-facing Services — viewing, posting, following, messaging, subscribing, or otherwise interacting with content on wecitizens.social and our mobile clients. It does not cover (a) rev-shared influencers in their capacity as influencers, (b) fork operators in their capacity as operators, or (c) the end users of any third-party fork that is operated by someone other than WeCitizens Social. Those categories are addressed in separate documents linked at the end of this Policy.

---

## 2. Nostr Identity, Public-by-Default Events, and What Leaves Our Control

This is the section a careful reader most needs to understand before posting on WeCitizens Social. Nostr is a public, cryptographic, federated protocol. Its data model is different from a closed social network and the privacy consequences are different too.
...
(e) **Law enforcement and legal process.** We disclose personal information in response to valid legal process, to comply with Applicable Law, to enforce the Consumer Terms of Service, to protect the rights, property, or safety of WeCitizens Social, our Consumers, or the public, and to NCMEC for CSAM reports.
...
* Email: contactus@act3ai.com (with subject line "Privacy Request").
* Web form: wecitizens.social/privacy/request.
...
* **Sharing (cross-context behavioral advertising).** We do not engage in "sharing" of personal information for cross-context behavioral advertising as that term is defined by the CCPA, except where you have opted in. If you have opted in and wish to opt out, you may do so at wecitizens.social/privacy/do-not-sell-or-share.
...
(k) **Metrics.** We publish CCPA request-and-response metrics annually at wecitizens.social/privacy/metrics where the law requires it.

---

## 13. Other U.S. State Privacy Rights (Virginia, Colorado, Connecticut, Utah, and Others)

If you reside in Virginia (VCDPA), Colorado (CPA), Connecticut (CTDPA), Utah (UCPA), or another U.S. state with a comprehensive consumer-privacy statute then in force, you have rights substantially similar to those described in Section 11 — access, correction (where the statute provides it), deletion, portability, and opt-out of targeted advertising, sale, and certain profiling. We do not engage in targeted advertising or sale as those terms are defined in those statutes. Appeals of any denied request may be submitted to contactus@act3ai.com and will be reviewed by a person not involved in the original decision. We will respond to an appeal within the timeline required by the applicable statute (typically forty-five (45) to sixty (60) days). If your appeal is denied you may contact your state attorney general.

---

## 14. Children Under 13 (COPPA) and Minors 13 to 17

(a) **Children under 13.** The Services are not directed to children under the age of thirteen (13). We do not knowingly collect personal information from a child under 13. If we learn that a child under 13 has provided personal information, we delete it and terminate the Account. If you are a parent or guardian and you believe a child under 13 has given us personal information, contact us at contactus@act3ai.com.
...
* Privacy requests: contactus@act3ai.com
* Privacy appeals: contactus@act3ai.com
* Web form: wecitizens.social/privacy/request
* In-product: Settings → Privacy → Privacy Requests
...
WeCitizens Social maintains three companion legal documents. This **Consumer (WeCitizens.social User)** Privacy Policy pairs with the Consumer Terms of Service. The privacy policies for the two other audiences are:

* **Rev-Shared Influencers Privacy Policy** — [`/influencers/privacy`](/influencers/privacy). Applies to persons who refer paying users under the WeCitizens Social influencer rev-share program.
* **WeCitizens Fork Operator Privacy Policy** — [`/fork/privacy`](/fork/privacy). Applies to operators who run their own social network using our source-available code; the operator is the data controller of its own end users.
