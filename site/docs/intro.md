...
Nostr (Notes and Other Stuff Transmitted by Relays) is a simple, open protocol for decentralized social networking. Instead of relying on a single company's servers, Nostr uses a network of relays that anyone can run.

### Key Concepts

- **Keys, not accounts** - Your identity is a cryptographic key pair. Your public key is your username, your private key is your password. No email or phone number required.
...
- **Portable identity** - Take your profile and followers to any Nostr client
